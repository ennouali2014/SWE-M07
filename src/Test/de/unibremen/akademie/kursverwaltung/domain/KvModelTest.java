...
class KvModelTest {
    ...
    private final String SPEICHERPFAD = "src/test/resources/storage/";
    private final String VERWALTUNGSDATEITEST = "gespeicherteTestObjekte";
    ...
    void saveLoadtest() {
        ...
        testModel.save(SPEICHERPFAD, VERWALTUNGSDATEITEST);
        testModel.getKurse().getKursListe().clear();
        testModel.getPersonen().getPersonenListe().clear();
        testModel.load(SPEICHERPFAD, VERWALTUNGSDATEITEST);
